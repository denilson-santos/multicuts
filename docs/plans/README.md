...
The integrated pipeline currently stops after boundary refinement.

Packages 010–013 completed selection, semantic/hybrid scoring, and boundary
refinement. Package 014 is now active on the M3 path through final-geometry
...
| [014 Clip rendering](014-clip-rendering/) | M3 | in-progress | P1 | 004, 013 | — | Safe accurate `original` and center-cropped `9:16` raw clips |
