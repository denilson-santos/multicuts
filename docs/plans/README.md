...
complete run manifest is integrated; CLI outcome semantics and end-to-end
acceptance remain package 016 work.
...
| [016 Run artifacts and end-to-end completion](016-run-artifacts/) | M3 | in-progress | P1 | 010, 011, 014, 015 | [#42](https://github.com/denilson-santos/multicuts/pull/42), [#43](https://github.com/denilson-santos/multicuts/pull/43) | Complete per-clip metadata, run manifest, and honest final CLI outcomes |
...
integrated. CLI outcome mapping precedes end-to-end acceptance.
