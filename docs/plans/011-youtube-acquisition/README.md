...
| --- | --- | --- | --- | --- | --- |
| [001 Define source routing and metadata contracts](001-define-source-routing.md) | in-progress | P2 | Packages 003, 004 | — | Explicit local/YouTube routing and safe normalized source metadata |
| [002 Implement the yt-dlp adapter](002-implement-youtube-adapter.md) | in-progress | P2 | 001 | — | Controlled download and stable provider-independent result |
| [003 Integrate and verify YouTube acquisition](003-integrate-youtube-acquisition.md) | in-progress | P2 | 002, Package 006 | — | Remote sources enter the existing probe/transcript path safely |
