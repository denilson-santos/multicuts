...
| --- | --- | --- | --- | --- | --- |
| [001 Define versioned score contracts](001-define-score-contracts.md) | in-progress | P1 | Package 008 | — | Valid score dimensions, confidence, penalties, reason, and provenance |
| [002 Implement heuristic judgments](002-implement-heuristic-judgments.md) | in-progress | P1 | 001 | — | Deterministic dimension evidence without fabricated provider output |
| [003 Compose final scores and penalties](003-compose-scores-and-penalties.md) | in-progress | P1 | 002 | — | Reproducible weighted `0..100` results under `scoring-v1` |
| [004 Persist and integrate heuristic scoring](004-persist-and-integrate-scoring.md) | in-progress | P1 | 003 | — | Reusable scored candidates and an operational heuristic pipeline path |
